                ...
                <div style={{ background: '#ffffff', padding: '16px', borderRadius: '8px', border: '1px solid #dfe1e5' }}>
                  ...
                  <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                    <input 
                      ...
                      className="form-input" 
                      readOnly 
                      value={`${process.env.NEXT_PUBLIC_SITE_URL || 'https://pishare.site'}/register?ref=${user.username}`} 
                    ...
                    <button 
                      ...
                      onClick={(e) => {
                        const linkStr = `${process.env.NEXT_PUBLIC_SITE_URL || 'https://pishare.site'}/register?ref=${user.username}`;
